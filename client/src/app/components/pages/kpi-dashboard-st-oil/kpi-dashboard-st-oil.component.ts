...
@Component({
  selector: 'app-kpi-dashboard-st-oil',
  templateUrl: './kpi-dashboard-st-oil.component.html',
  styleUrls: ['./kpi-dashboard-st-oil.component.css']
})
export class KpiDashboardStOilComponent implements OnInit {
    Id:Number;
    wellArray: any;
    public selected;
    private gridApi;
