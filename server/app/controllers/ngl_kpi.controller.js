...
const ngl_kpicollection = db.ngl_kpis;
...
exports.create = (req, res) => {
    // Validate request
      ...
      // Create a KPI
     const ngl_kpi = new st_kpicollection({
        company: "Company",
        asset: "Asset-1",
        field: "Field-ABAC",
        reservoir: "Res-AB",
...
exports.findAll = (req, res) => {
   ...
   ngl_kpicollection.find(condition)
      .then(data => {
        res.send(data);
      })
      .catch(err => {
...
exports.update = (req, res) => {
    ...
    ngl_kpicollection.findByIdAndUpdate(id, req.body, { useFindAndModify: false })
      .then(data => {
        if (!data) {
          res.status(404).send({
...
exports.delete = (req, res) => {
    ...
    ngl_kpicollection.findByIdAndRemove(id)
      .then(data => {
        if (!data) {
          res.status(404).send({
...
exports.findAllPublished = (req, res) => {
  ngl_kpicollection.find({ published: true })
    .then(data => {
      res.send(data);
    })
    .catch(err => {
